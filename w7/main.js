...
// function renderTbl() {
//   const tableS = document.createElement("table"); // I was having trouble because I could not make doubles so it trew my naming off  
//   const tbody = document.createElement("tbody");
//   const td = document.createElement("td");
//   const tr = document.createElement("td");
//   const headingTextArr = ["juan", "6", "large", "14"]; // I tried to get code to come up like the above function but nothing
